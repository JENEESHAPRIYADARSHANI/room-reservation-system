    ...
    <div class="home-content">
      <div class="overview-boxes">
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="number">
              ...
              $sql = "SELECT COUNT(*) AS booked FROM normalroomm";
              $result = $conn->query($sql);
              $row = $result->fetch_assoc();
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="number">
              <?php
              $sql = "SELECT count(*) as total from normalroomm";
              $result = $conn->query($sql);
              $row = $result->fetch_assoc();
              echo $row['total'];
              ?>
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title">Normal Room</div>
          <div class="limiter">
